...
### Backend and agent
- 108 backend tests + 12 E2E browser tests pass; ruff clean.
...
| Full 59-case agent benchmark | Running at time of writing | `docs/agent_evaluation.md` is regenerated by the run |
